...
const MainBanner = () => {
  return (
    <div className='relative'>
        <img src={assets.main_banner_bg} alt='main-banner' className='hidden md:block w-full'/>
        <img src={assets.main_banner_bg_sm} alt='main-banner-sm' className='md:hidden w-full'/>
