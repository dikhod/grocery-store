...
const ProductCard = ({product}) => {
    ...
    const {cartItems, addToCart, removeFromCart, updateCartItems, navigate} = useAppContext();
            ...
            <div className="text-gray-500/60 text-sm">
                ...
                <div className="flex items-center gap-0.5">
                    {Array(5).fill('').map((_, i) => (
                         <img src={i<4 ? assets.star_icon : assets.star_dull_icon} className="md:w-3.5 w-3"/>
                     ))}
                    <p>(4)</p>
                </div>
