...
const ProductDetails = () => {
    ...
    useEffect(()=>{
        setRelatedProducts((products.filter((item)=> item.category === product.category)).slice(0,5));
     },[products])
        ...
        <div className="mt-12">
            ...
            <div className='mt-20 flex flex-col items-center'>
                <div className='flex flex-col items-center'>
                    ...
                    <div className='w-20 h-0.5 bg-primary mt-2'></div>
                </div>
                ...
                <button onClick={()=> navigate('/products')} className='cursor-pointer border px-12 py-2.5 my-16 mx-auto rounded text-primary hover:bg-primary/10 transition'>See More</button>
            </div>
        </div>
    );
};
